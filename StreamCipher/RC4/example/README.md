...
The file `cipher.data` is the output obtained by using `plain.txt` as input
file for the RC4 StreamCipher program from Task 3, with the key from the
file `key.txt` as key. To check that your StreamCipher program
